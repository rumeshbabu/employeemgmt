		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Validations",
									"targetURL": "#comactetutday9validations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comactetutday9validations-display": {
								"semanticObject": "comactetutday9validations",
								"action": "display",
								"description": "A Fiori application for validations",
								"title": "Validations",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.acte.tut.day9validations",
									"url": sap.ui.require.toUrl("com/acte/tut/day9validations")
								}
							}
						}
					}
